...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    screens: [
      ...
      { name: 'Choose Method', path: '/(payment)/enter-rent', params: { modalView: 'selector' } },
      { name: 'Add UPI', path: '/(payment)/enter-rent', params: { modalView: 'add-upi' } },
      { name: 'Add Credit Card', path: '/(payment)/enter-rent', params: { modalView: 'add-card' } },
      { name: 'Add Debit Card', path: '/(payment)/enter-rent', params: { modalView: 'add-debit-card' } },
      { name: 'Add Netbanking', path: '/(payment)/enter-rent', params: { modalView: 'add-netbanking' } },
      { name: 'Edit Method', path: '/(payment)/enter-rent', params: { modalView: 'edit-method' } },
