 ...
 *
 * Design: A continuous horizontal line connecting 3 dots, with labels below.
 * - Dot: 11x11, borderRadius 4 (rounded square)
 * - Active dot: #FF9A6D, Inactive dot: #4D4D4D, Failed dot: #E5484D, Success: #4CAF50
 * - Line segments between dots inherit the color of the left dot
 * - Label: PlusJakartaSans-Regular, 12px, lineHeight 16.92, letterSpacing -0.24, #878787
 */
...
function PaymentProgressBarComponent({ cardStatus }: PaymentProgressBarProps) {
...
export const PaymentProgressBar = memo(PaymentProgressBarComponent);
