...
const reviewResponses: Record<string, unknown> = {
  ...
  'dashboard-data': {
    ...
    tenancy: {
      ...
      verification_status: {
        ...
        credit_card_disabled_reason: null,
      },
    },
    upcoming_payment: {
      due_date: '2026-03-05',
      ...
      flat_bonus_eligible: false,
      flat_bonus_paise: 0,
    },
    cashback: {
      discount_rate: 0.01,
      max_discount_paise: 25000,
      max_discount: 250,
      verification_complete: true,
      total_savings_paise: 50000,
      total_savings: 500,
  ...
  'generate-receipt': {
    ...
    payment: {
      ...
      payment_gateway_id: 'review-pg-001',
      amount: 25000,
      pg_fee: 0,
      cashback_applied: 250,
      cashback_earned: 250,
      flat_bonus: 0,
      one_pct_cashback: 250,
      net_amount_paid: 24750,
      payment_method: 'upi',
      status: 'success',
      rent_month: '2026-02',
  ...
  'get-payment-stamps': {
    stamps: [
      ...
      },
      {
        ...
        days_late: null,
        amount_paise: null,
        cashback_applied_paise: null,
        cashback_earned_paise: null,
        payment_method: null,
      },
    ],
    summary: {
  ...
  'calculate-cashback': {
    ...
    legacy_wallet_balance: 0,
    legacy_total_earned_paise: 0,
    legacy_total_redeemed_paise: 0,
    history: [
      {
        id: 'review-cb-001',
        type: 'discount',
        ...
        amount: 250,
        payment_id: REVIEW_PAYMENT_ID,
        description: '1% instant discount — February 2026',
      ...
      },
      {
        ...
        amount: 250,
        payment_id: 'review-pay-002',
        description: '1% instant discount — January 2026',
