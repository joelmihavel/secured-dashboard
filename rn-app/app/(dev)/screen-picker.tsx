...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    icon: 'P',
    screens: [
      { name: 'Select Method', path: '/(payment)/select-method', figmaNode: '41:8901' },
      ...
      { name: 'Add Card', path: '/(payment)/add-card', figmaNode: '41:8529' },
      ...
      { name: 'Failed', path: '/(payment)/failed', figmaNode: '41:9511' },
    ],
  },
  {
    label: 'Profile',
  ...
  },
  {
    ...
    icon: '$',
    screens: [
      { name: 'Profile Payment', path: '/(profile-payment)' },
    ],
  },
  {
    label: 'Setup',
