...
#
# Usage:
#   ./scripts/auto-heal-parity.sh [screen_name]
#   ./scripts/auto-heal-parity.sh           # All screens
#   ./scripts/auto-heal-parity.sh home      # Single screen
#   ./scripts/auto-heal-parity.sh --download-baselines [--force]
#   ./scripts/auto-heal-parity.sh --compare-only       # Skip capture, just compare
# =============================================================================
