  ...
  for (const bn of blueprintNodes) {
    const figmaNode: FigmaNode = {
      ...
      figmaData: {
        ...
        absoluteRenderBounds: bn.absoluteRenderBounds,
        opacity: bn.opacity,
        fills: bn.fills,
        strokes: bn.strokes,
        effects: bn.effects,
        borderRadius: bn.borderRadius,
        cornerSmoothing: bn.cornerSmoothing,
        clipsContent: bn.clipsContent,
        layout: bn.layout,
        layoutSizingHorizontal: bn.layoutSizingHorizontal,
        layoutSizingVertical: bn.layoutSizingVertical,
        typography: bn.typography,
        textContent: bn.textContent || bn.typography?.content,
        visible: bn.visible,
        rnComponent: bn.rnComponent,
        scrollBehavior: bn.scrollBehavior,
        overflowDirection: bn.overflowDirection,
        boundVariables: bn.boundVariables,
        styleReferences: bn.styleReferences,
        componentId: bn.componentId,
        componentProperties: bn.componentProperties,
        componentPropertyReferences: bn.componentPropertyReferences,
        interactions: bn.interactions,
      },
      children: [],
    };
