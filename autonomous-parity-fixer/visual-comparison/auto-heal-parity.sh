...
#
# Usage:
#   ./visual-comparison/auto-heal-parity.sh [screen_name]
#   ./visual-comparison/auto-heal-parity.sh           # All screens
#   ./visual-comparison/auto-heal-parity.sh home      # Single screen
#   ./visual-comparison/auto-heal-parity.sh --download-baselines [--force]
#   ./visual-comparison/auto-heal-parity.sh --compare-only       # Skip capture, just compare
# =============================================================================
...
BASELINES_DIR="$PROJECT_DIR/figma/baselines"
SCREENSHOTS_DIR="$PROJECT_DIR/figma/screenshots/latest"
DIFFS_DIR="$PROJECT_DIR/figma/screenshots/diffs"
THUMBS_DIR="$PROJECT_DIR/figma/thumbnails"
REPORT_FILE="$PROJECT_DIR/figma/parity-report.md"
