...
Contains 90 pre-computed React Native styles.
...
- "pending" → styles.textHere
- "Payment Processing" → styles.paymentProcessing
- "We’ve received your payment request." → styles.weveReceivedYourPaymentRequest
- "This can take a few minutes depending on your bank." → styles.thisCanTakeAFewMinutesDependingOnYourBan
- "You’ll see confirmation here once it’s complete." → styles.youllSeeConfirmationHereOnceItsComplete
- "Contact Support" → styles.text
- "13:13" → styles.time

## Key Frame Dimensions

- Pay Rent / Payment Summary Page --Payment Processing: 393x852
