...
## Screen: Screen 243-3170 (243-3170)
...
- "⚠️ Cashback may be impacted if delayed further" → styles.CashbackMayBeImpactedIfDelayedFurther
- "Your rent is overdue by 10 days" → styles.yourRentIsOverdueBy10Days
...
- Home --active --complete setup /all methods -late payment: 393x1384
