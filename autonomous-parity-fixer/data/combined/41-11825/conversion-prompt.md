...
## Screen: Screen 41-11825 (41-11825)
...
Contains 145 pre-computed React Native styles.
...
- "13:13" → styles.time
- "We’re still  setting  things up" → styles.wereStillSettingThingsUp
...
- "Approximately 24-48 hrs" → styles.approximately2448Hrs
- "Account Status" → styles.accountStatus
- "Pending" → styles.pending
- "18 / 150  members onboarded" → styles.18150MembersOnboarded
- "This  release" → styles.hintText
- "Have an Invite Code?" → styles.haveAnInviteCode
- "Get priority access to the platform if you use a referral code" → styles.getPriorityAccessToThePlatformIfYouUseAR
- "Move up the waitlist" → styles.label
- "0" → styles.text

## Key Frame Dimensions

- Onboarding / Waitlist Screen -- more than 24hrs: 393x1766
- Frame 2095586324: 393x1598.4000244140625
- Battery: 27.22842788696289x13
- Frame 1686557268: 393x1481.4000244140625
- Frame 1686557318: 313x1481.4000244140625
