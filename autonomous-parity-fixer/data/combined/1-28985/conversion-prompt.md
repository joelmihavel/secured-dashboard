...
- "13:13" → styles.time
- "Earn 1% back on your rent" → styles.earn1BackOnYourRent
- "For every timely payment made via UPI, netbanking or credit cards." → styles.forEveryTimelyPaymentMadeViaUpiNetbankin
- "Skip →" → styles.loginText

## Key Frame Dimensions

- Splash / get-started --carousel 4: 393x852
