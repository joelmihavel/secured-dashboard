...
- "13:13" → styles.time
- "Your landlord benefits too" → styles.yourLandlordBenefitsToo
- "3 months of rent payments unlock a free vacancy cover for your landlord" → styles.3MonthsOfRentPaymentsUnlockAFreeVacancyC
- "Skip →" → styles.loginText

## Key Frame Dimensions

- Splash / get-started --carousel 6: 393x852
